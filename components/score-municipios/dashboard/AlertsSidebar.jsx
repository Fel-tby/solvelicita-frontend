...
export default function AlertsSidebar({ nCritico, nDispensa, nDefasado, nSemDados, nAtrasos, nBloqueioAutonomia, applyFilter }) {
  const alerts = [
    ...
    },
    {
      id: 'dispensa',
      count: nDispensa,
      label: 'municípios com sinais em compras diretas',
      icon: <Bell size={16} />,
      color: '#f97316',
    ...
    },
    {
      id: 'defasado',
      count: nDefasado,
      label: 'municípios com dados desatualizados',
      icon: <Clock size={16} />,
      color: '#f59e0b',
    ...
    },
    {
      id: 'pncp',
      count: nSemDados,
      label: 'municípios com lacunas no PNCP',
  ...
  return (
    <div className="dash-v3-alerts-container">
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
        ...
        <h3 style={{ fontSize: '0.82rem', fontWeight: 700, margin: 0, color: 'var(--text-hi)' }}>Alertas do estado</h3>
      </div>
