    ...
    <div className="dash-v3-filters">
      <div className="dash-v3-filter-group">
        ...
        <select className="dash-v3-select" value={filtros.classificacao} onChange={(e) => handleChange('classificacao', e.target.value)}>
          ...
          <option value="baixo">Alto desempenho</option>
          <option value="medio">Estável</option>
          <option value="alto">Atenção</option>
      ...
      <div className="dash-v3-filter-group">
        <span className="dash-v3-filter-label"><Filter size={12} /> % compras diretas</span>
      ...
      <div className="dash-v3-filter-group">
        <span className="dash-v3-filter-label"><Filter size={12} /> Alertas públicos</span>
      ...
      <div className="dash-v3-filter-group">
        <span className="dash-v3-filter-label"><Filter size={12} /> Volume de compras</span>
