export const siteConfig = {
  ...
  repoUrl: 'https://github.com/Fel-tby/solvelicita-engine',
  methodologyUrl: 'https://github.com/Fel-tby/solvelicita-engine/blob/main/docs/METODOLOGIA.md',
  githubLabel: 'github.com/Fel-tby/solvelicita-engine',
